    ...
    return (
        <div style={{ padding: '1.5rem', maxWidth: '1100px', margin: '0 auto' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem' }}>
                <div>
                    <h1 style={{ fontWeight: 800, fontSize: '1.5rem', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
            ...
            <div style={{ display: 'flex', gap: '0.5rem', marginBottom: '1.5rem' }}>
                {[
                    ...
                    <button key={tab.id} onClick={() => setFilter(tab.id)} style={{
                        ...
                        background: filter === tab.id ? 'var(--color-primary-600)' : 'var(--color-slate-100)',
            ...
            {filtered.length === 0 ? (
                <Card className="padding-lg" style={{ textAlign: 'center' }}>
                    ...
                    <p style={{ fontWeight: 500 }}>No changes found</p>
                            ...
                            <Card key={change.id} className="padding-none" style={{ borderLeft: `4px solid ${sc.color}`, overflow: 'hidden' }}>
                                ...
                                <div style={{ padding: '1rem 1.25rem' }}>
                                    ...
                                    <div style={{
                                        ...
                                        background: 'var(--color-slate-50)', border: '1px solid var(--color-border)'
                                    }}>
                                        <div>
