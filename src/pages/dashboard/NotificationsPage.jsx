...
const NotificationsPage = () => {
    ...
    const typeColors = {
        invoice: { bg: '#dbeafe', color: '#2563eb' },
        leave: { bg: '#fef3c7', color: '#d97706' },
        audit: { bg: '#f5f3ff', color: '#7c3aed' },
        payroll: { bg: '#d1fae5', color: '#059669' },
        system: { bg: '#f1f5f9', color: '#475569' },
        inventory: { bg: '#fee2e2', color: '#dc2626' },
        payment: { bg: '#e0e7ff', color: '#4f46e5' },
        approval: { bg: '#d1fae5', color: '#059669' },
                            ...
                            >
                                ...
                                <div style={{ flex: 1 }}>
                                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                                        <div>
                                            <h4 style={{ fontWeight: notif.read ? 500 : 700, fontSize: '0.9rem', marginBottom: '0.2rem' }}>{notif.title}</h4>
