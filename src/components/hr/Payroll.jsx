...
const Payroll = () => {
  ...
  const nextPayLabel =
    dashboard?.nextPayDate != null
      ? formatPayDate(dashboard.nextPayDate)
      : null;
            ...
            <>
              <div className={styles.dashboardKpis}>
                  ...
                  >
                    <div>
                      ...
                      <div style={{ fontSize: "1.5rem", fontWeight: 700 }}>
                        {formatMoneyAmount(
                          dashboard.totalPayrollCost,
                          dashboard.costCurrency,
                        )}
                      </div>
                      <p
                        style={{
                      ...
                      >
                        {dashboard.totalPayrollCostMeta ||
                          "Aggregate payroll cost"}
                      </p>
                    </div>
                  </div>
                </Card>
                ...
                <Card className="padding-md">
                  ...
                  >
                    {dashboard.lastRunStatusMeta ||
                      [lastRun?.journal_reference, lastRun?.period_name]
                        .filter(Boolean)
                        .join(" · ") ||
                      "No recent run"}
                  </p>
