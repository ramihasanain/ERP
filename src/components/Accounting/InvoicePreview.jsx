...
const InvoicePreview = () => {
  ...
  const getStatusStyle = (status) => {
    ...
    if (value === "paid") {
      return {
        bg: "color-mix(in srgb, var(--color-success) 18%, var(--color-bg-card))",
    ...
    if (value === "partial") {
      return {
        bg: "color-mix(in srgb, var(--color-warning) 18%, var(--color-bg-card))",
        color: "var(--color-warning)",
      };
    }
    if (value === "overdue") {
      return {
        bg: "color-mix(in srgb, var(--color-error) 18%, var(--color-bg-card))",
  ...
  const invoice = useMemo(() => {
    ...
    return {
      ...
      client: {
        ...
        address:
          data.billing_address || "123 Innovation Drive, Tech City, TC 90210",
        email:
          data.customer_email ||
          data.customer?.email ||
          "finance@unifiedcore.com",
        phone:
          data.customer_phone || data.customer?.phone || "+1 (555) 000-1234",
      },
    ...
    return (
      ...
      >
        <Button
          ...
          onClick={() => navigate(`${basePath}/accounting/invoices`)}
  ...
  return (
    ...
    >
      ...
      <Card
        className="padding-none invoice-print-content"
        ...
        <div style={{ padding: "3rem" }}>
            ...
            <div style={{ textAlign: "right" }}>
              <h2
                style={{
                  ...
                  fontWeight: 800,
                  color:
                    "color-mix(in srgb, var(--color-primary-600) 28%, var(--color-bg-card))",
          ...
          >
            ...
            >
              ...
              >
                ...
                {invoice.amountsIncludeTax ? "Yes" : "No"}
              </div>
              <div
                style={{
                  color: "var(--color-text-secondary)",
              ...
              <tbody>
                {invoice.items.map((item) => (
                  ...
                  >
                    ...
                    >
                      {invoice.currency} {item.lineNet.toFixed(2)}
                    </td>
                    <td
                      style={{
                        padding: "1.25rem 0",
                    ...
                    >
                      {invoice.currency} {item.lineTax.toFixed(2)}
                    </td>
                    <td
                      style={{
                        padding: "1.25rem 0",
          ...
          <div style={{ display: "flex", justifyContent: "flex-end" }}>
            <div style={{ width: "300px" }}>
              ...
              >
                ...
                >
                  {invoice.currency} {invoice.remainingBalance.toFixed(2)}
                </span>
              </div>
            </div>
          </div>
          ...
          >
            ...
            <p>
              ...
              <strong>{invoice.company.name}</strong>. Payment is due based on
              the due date above.
            </p>
          </div>
        </div>
