...
const notifUnreadBg =
  "color-mix(in srgb, var(--color-primary-600) 12%, var(--color-bg-surface))";
const notifUnreadHover =
  "color-mix(in srgb, var(--color-primary-600) 22%, var(--color-bg-surface))";
