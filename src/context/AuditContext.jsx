...
const DEFAULT_CLIENT_COMPANIES = [
  {
    ...
    bankAccounts: [
      {
        bankName: "Arab Bank",
        accountNumber: "JO94ARAB0000001234567890",
        iban: "JO94ARAB0000001234567890",
        currency: "JOD",
      ...
      },
      {
        ...
        accountNumber: "JO52JKBI0000009876543210",
        iban: "JO52JKBI0000009876543210",
        currency: "JOD",
      ...
      {
        bankName: "Arab Bank",
        accountNumber: "JO12ARAB0000005555666677",
        iban: "JO12ARAB0000005555666677",
        currency: "USD",
    ...
    bankAccounts: [
      {
        ...
        accountNumber: "JO88HBHO0000002222333344",
        iban: "JO88HBHO0000002222333344",
        currency: "JOD",
        type: "Current Account",
        balance: 175000,
      },
      {
        ...
        accountNumber: "JO33CAAB0000004444555566",
        iban: "JO33CAAB0000004444555566",
        currency: "JOD",
        type: "Current Account",
        balance: 68000,
      },
  ...
  },
  {
    ...
    bankAccounts: [
      {
        bankName: "Arab Bank",
        accountNumber: "JO77ARAB0000007777888899",
        iban: "JO77ARAB0000007777888899",
        currency: "JOD",
        type: "Current Account",
        balance: 890000,
      },
      {
        ...
        accountNumber: "JO55BJOR0000001111222233",
        iban: "JO55BJOR0000001111222233",
        currency: "JOD",
        type: "Project Escrow",
        balance: 350000,
      },
      {
        bankName: "Arab Bank",
        accountNumber: "JO44ARAB0000006666777788",
        iban: "JO44ARAB0000006666777788",
        currency: "USD",
        type: "Foreign Currency",
        balance: 125000,
      },
    ...
    shareholders: [
      ...
      {
        name: "Al-Noor Investment Group",
        share: 25,
        role: "Strategic Investor",
      },
      {
        name: "Jordanian Construction Fund",
        share: 20,
...
export const AuditProvider = ({ children }) => {
  ...
  const currentAuditor = useMemo(() => {
    if (user?.role !== "Auditor" && user?.role?.name !== "Auditor") return null;
    return {
  ...
  const updateFirm = (firmId, updates) => {
    setAuditFirms((prev) =>
      prev.map((f) => (f.id === firmId ? { ...f, ...updates } : f)),
    );
  };
  ...
  const requestRevision = (periodId, notes) => {
    setAuditPeriods((prev) =>
      prev.map((p) =>
        p.id === periodId
          ? { ...p, status: AUDIT_STATUSES.REVISION, auditorNotes: notes }
          : p,
      ),
    );
  };
  ...
  const isMonthLocked = (month, year) => {
    const period = auditPeriods.find(
  ...
  const canAdminEdit = (periodId) => {
    ...
    return [AUDIT_STATUSES.OPEN, AUDIT_STATUSES.REVISION].includes(
      period.status,
    );
  };
  ...
  const getAuditorCompanies = (auditorId) => {
    const periodCompanyIds = [
      ...new Set(
        auditPeriods
          .filter((p) => p.auditorId === auditorId)
          .map((p) => p.companyId),
      ),
    ];
  ...
  const [adjustments, setAdjustments] = useState([
    {
      ...
      description:
        "Deferred revenue should be recognized in January per IFRS 15.",
    ...
    },
    {
      ...
      description:
        "Insurance prepaid for Q1 should be expensed as the period has passed.",
      status: "rejected",
      createdAt: "2025-03-11",
  ...
  const getAdjustmentsForPeriod = (periodId) =>
    adjustments.filter((a) => a.periodId === periodId);
  const getAdjustmentsForCompany = (companyId) =>
    adjustments.filter((a) => a.companyId === companyId);
  ...
  const [auditChanges, setAuditChanges] = useState([
    {
      ...
      entityId: "4110",
      field: "name",
      oldValue: "Sales Revenue",
      newValue: "Product Sales Revenue",
      auditorId: "AUDIT-001",
      auditorName: "Deloitte Jordan",
      periodId: "PRD-001",
      companyId: "COMP-001",
      ...
      status: "approved",
      reviewedAt: "2025-02-19",
      adminNotes: "Name updated.",
    },
    {
      id: "CHG-002",
      entityType: "journal_line",
      entityId: "JE-2025-002",
      field: "debit (line 1)",
      oldValue: "12000",
      newValue: "13500",
      auditorId: "AUDIT-001",
    ...
    },
    {
      ...
      entityId: "JE-2025-003",
      field: "description",
      oldValue: "Office Rent Payment",
      newValue: "Office Rent Payment - Q1 2025",
      auditorId: "AUDIT-001",
      auditorName: "Deloitte Jordan",
      periodId: "PRD-002",
      companyId: "COMP-001",
      ...
      status: "rejected",
      reviewedAt: "2025-03-12",
      adminNotes: "Original description is sufficient.",
    },
  ]);
  ...
  const getPendingChanges = () =>
    auditChanges.filter((c) => c.status === "pending");
  const getChangesForPeriod = (periodId) =>
    auditChanges.filter((c) => c.periodId === periodId);
